<template>
  <view class="add-success">
    ...
    <image
      class="background"
      mode="scaleToFill"
      src="http://192.168.1.187:10088/static/support/bg-support-bind-success.png"
    />
    ...
    <view class="card flex-v flex-c-c bg-white br-24">
      <image
        ...
        mode="scaleToFill"
        v-if="!uactId"
        src="http://192.168.1.187:10088/static/support/icon-support-avatar-send.png"
      />
      <image
        class="avatar"
        mode="scaleToFill"
        v-if="uactId"
        src="http://192.168.1.187:10088/static/support/icon-support-avatar-success.png"
      />
    ...
    <image
      class="img-bt"
      src="http://192.168.1.187:10088/static/support/image-support-rights-instruction.png"
      mode="scaleToFill"
    />
  </view>
</template>
