  ...
  <view class="add-success">
    ...
    <view class="card flex-v flex-c-c bg-white br-24">
      <image
        ...
        v-if="uactId === ''"
        mode="scaleToFill"
        src=".http://192.168.1.187:10088/static/family-account/icon-support-avatar-send.png"
      />
      <image
        class="avatar"
        v-if="uactId !== ''"
        mode="scaleToFill"
        src="http://192.168.1.187:10088/static/family-account/icon-support-avatar-success.png"
      />
      ...
      <text v-if="names.length > 0" class="message fs-36 c-lightgrey mt-16">
        ...
        <template v-for="(item, index) in names">
          ...
          <text :key="'pause-' + index" v-if="index !== names.length - 1">、</text>
        </template>
    ...
    >
      <image
        class="credits-image"
        mode="scaleToFill"
        src="http://192.168.1.187:10088/static/family-account/image-common-credits2-100.png"
      />
      <image
