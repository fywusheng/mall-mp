        ...
        <view 
          ...
          @touchend="touchend(item)">
            <view class="list-item">
              ...
              <view class="bann-name">{{item.bankName}}({{item.bankCardNum | formatBankNum}})</view>
  ...
  data() {
    return {
      ...
      icon: {
        ...
        drag: 'https://ggllstatic.hpgjzlinfo.com/static/pay/icon-drag.png',
      },
      // 导航栏高度
      //#ifdef MP-WEIXIN
      ...
      api.getBankList({
        ...
        success: res => {
          ...
          let mockRes = [  {
              ...
              "bankName": "民生银行",
              "bankIcon": "http://120.42.37.88:10088/nepsp-file/group1/M00/45/FF/wKgupGF45reAEFJCAAAf2PbeKz8685.png",
