<template>
  <view class="bank-card-picker">
    ...
    <view class="search-panel">
      <image class="icon-search" src="http://192.168.1.187:10088/static/pay/icon-search.png" />
    ...
    >
      ...
      >
        ...
        >
          <image class="icon-bank" src="http://192.168.1.187:10088/static/pay/icon-search.png" />
