  ...
  <view class="open-online-pay">
    ...
    <view class="page-header mt-16">
      <view class="img-warpper">
        <image class="icon-circle" :src="icon.auth" />
    ...
    <view class="xieyi">
      ...
      <view class="text">
        我已阅读并同意
        <text class="blue" @click="handleUserAgreementClick">《国家老龄服务平台实名认证协议》</text>
      </view>
    </view>
    ...
    >
      <view slot="text">
        <view class="confirm-main" style="height: auto; line-height: 1.5">
          <view class="content">
            绑卡尚未完成，将无法在国家老龄服务平台APP使用该卡，是否确认返回？
          </view>
        </view>
      </view>
    </modal>
    ...
    <!-- 预留手机号说明 -->
    <modal ref="phoneModal" cancelText=" " confirmText="知道了" @confirm="handleConfirmPhoneModal">
      <view slot="text">
        <view class="confirm-main" style="height: auto; line-height: 1.5">
          <view class="content">
            该银行预留手机号为网银签约手机号，可通过网银个人客户基本资料中预留手机号码或者联系银行客服更新处理。
          </view>
        </view>
      </view>
    </modal>
  ...
  export default {
    ...
    methods: {
      ...
      handleUserAgreementClick() {
        const url = `${ENV.H5}/#/agreement?type=3`;
        uni.navigateTo({
