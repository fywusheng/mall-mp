<template>
  <view class="pay-detail">
        ...
        <view class="order-info">
            ...
            <view class="list-item b-t valid-code">
                ...
                <view class="content">
                    ...
                    <button class="btn-code" @click="sendCode" hover-class="none" :disabled="enableSend">{{codeTxt}}</button>
                </view>
            </view>
        </view>
    </view>
    ...
    <pay-way-list ref="payWayPop" :list="bankList" :selectIndex="selectIndex" @select="handleSelect"/>
