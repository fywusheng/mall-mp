  ...
  <view class="auth-tip">
    ...
    <view class="page-header mt-16">
      ...
      <view class="error-txt">
        授权 招商银行 获取您的 身份信息（姓名、证件号)及以下信息为您提供相关服务。
      </view>
    </view>
...
export default {
  ...
  data() {
    return {
      ...
      // iconPath
      icon: {
        auth1: 'http://192.168.1.187:10088/static/pay/icon-auth-1.png',
        auth2: 'http://192.168.1.187:10088/static/pay/icon-auth-2.png',
        auth3: 'http://192.168.1.187:10088/static/pay/icon-auth-3.png'
      },
      // 导航栏高度
      // #ifdef MP-WEIXIN
