<template>
  <view class="verification-code">
    ...
    <view class="page-header mt-16">
      ...
      <view class="error-tip" :style="{opacity: showTip?1:0}">验证码不正确或已失效，请重新发送</view>

      <one-input :maxlength="6" v-model="validCode" @finish="finishedOne" :autoFocus="autoFocus"></one-input>
    </view>
