...
<template>
  <view class="service">
    <view class="top">
      <image class="_img" src="https://ggllstatic.hpgjzlinfo.com/static/home/ybbg_h.png"
        mode="scaleToFill" />
      <view class="space_line"></view>
      <bCase :colName="colName" ref="base"></bCase>
    </view>
    <image class="fix_btn" mode="widthFix" @click="startQuest"
      src="https://ggllstatic.hpgjzlinfo.com/static/home/yb_btn.png" />
  </view>
</template>
<script>
...
export default {
  ...
  methods: {
    startQuest() {
      ...
      const url = 'https://znkf.ylzinfo.com/ylzbigdata_znkf_fe/#/web_im_plugin?appId=c3ceba1d1345401ab85db3ca891ab265'
      uni.navigateTo({
