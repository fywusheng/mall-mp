...
<template>
  <view class="service">
    <view class="top">
      <view class="image">
        <image class="_img"
          src="https://ggllstatic.hpgjzlinfo.com/static/services/icon-older-wei.png"
          mode="scaleToFill" />
      </view>
      <view class="line_lable">
        <view class="item" @click="activeClick(i)" :class="tabIndex == i ? 'active':''"
          v-for="(v,i) in titleLables" :key="i">
          <view>{{v.name}}</view>
