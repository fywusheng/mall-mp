      ...
      <view slot="title1">
        <view class="navigation-bar flex-h flex-c-s">
          ...
          <image
            class="icon-desc"
            @click="handleDesc"
            src="http://192.168.1.187:10088/static/supermarket/icon-desc.png"
            mode="scaleToFill"
          />
          <text class="desc fs-36">说明</text>
          <view class="navigation-bar__title fs-44 c-black flex-1">优惠买单</view>
        </view>
      </view>
    </navigation-bar>
    <!-- #endif -->
    ...
    <view class="flex-h flex-c-b flex-wrap ml-32 mr-32 mt-24 supmarket">
      ...
      >
        ...
        <view class="count flex-h flex-c-c">
          <image
            class="img"
            src="http://192.168.1.187:10088/static/supermarket/icon-discount.png"
            mode="scaleToFill"
          />
