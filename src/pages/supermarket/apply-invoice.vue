<template>
  <view class="pages">
    ...
    <view
      ...
      :style="{
        marginBottom: info.invoiceStatus == '0' && info.transactionStatus == '1' ? '180rpx' : '',
      }"
    >
      <view class="content">
        <view class="msg-item flex-h fs-32 mb-20">
          ...
          <view class="msg-right flex-h choice" @click="handleChoiceClick">
            ...
            <image
              class="icon"
              src="http://192.168.1.187:10088/static/supermarket/yellow-arrow.png"
              mode="scaleToFill"
            />
          </view>
        </view>
        <view class="msg-item flex-h fs-32">
          ...
          <view class="msg-right" v-if="infoHeader.payeeName">{{ infoHeader.payeeName }}</view>
        </view>
        <view class="msg-item flex-h fs-32">
          <view class="msg-left">收票人手机号：</view>
          <view class="msg-right" v-if="infoHeader.payeePhone">{{ infoHeader.payeePhone }}</view>
        </view>
        <view class="msg-item flex-h fs-32">
          <view class="msg-left">收票人邮箱:</view>
          <view class="msg-right" v-if="infoHeader.payeeEmail">{{ infoHeader.payeeEmail }}</view>
        </view>
      </view>
    </view>
    <view class="btn-box">
