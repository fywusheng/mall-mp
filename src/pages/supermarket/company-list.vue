    ...
    <view class="list">
      <view class="item flex-h flex-c-b" v-for="(item,index) in list" :key="index">
        <view class="left flex-h" @click="handleSelect(index)">
          <view class="check-box" v-if="select !== '0'">
            <image class="img" v-if="current == index"
      ...
      <block v-if="list.length === 0">
        <view class="flex-v flex-c-c status-box">
          <image src="https://ggllstatic.hpgjzlinfo.com/static/supermarket/no-header.png"
            mode="scaleToFill" />
