<template>
  <view class="pages">
    <view class="list">
      <view class="item flex-h flex-c-b" v-for="(item, index) in list" :key="index">
        <view class="left flex-h" @click="handleSelect(index)">
          <view class="check-box" v-if="select !== '0'">
            <image
              class="img"
              v-if="current == index"
              src="http://192.168.1.187:10088/static/supermarket/icon-checked.png"
              mode="scaleToFill"
            />
          </view>
          <view class="main">
        ...
        <view class="right flex-h flex-c-c">
          <image
            ...
            src="http://192.168.1.187:10088/static/supermarket/icon-edited.png"
            mode="scaleToFill"
          />
          <image
            class="img"
            ...
            src="http://192.168.1.187:10088/static/supermarket/icon-delete.png"
            mode="scaleToFill"
          />
        </view>
      </view>
      ...
      <block v-if="list.length === 0">
        <view class="flex-v flex-c-c status-box">
          <image
            src="http://192.168.1.187:10088/static/supermarket/no-header.png"
            mode="scaleToFill"
          />
