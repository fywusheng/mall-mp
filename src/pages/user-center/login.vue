<template>
  <view class="login">
    ...
    <view class="row flex-h flex-c-s m-0-60 b-b-line" v-if="loginType === 'smsCode'">
    ...
    <view class="row flex-h flex-c-s m-0-60 b-b-line" v-else-if="loginType === 'password'">
    ...
    <view class="footer">
      ...
      <view class="fs-36">
        我已阅读并同意
        <text class="c-code" @click="handleUserAgreementClick">《用户协议》</text>
        和
        <text class="c-code" @click="handlePrivacyPolicyClick">《隐私协议》</text>
