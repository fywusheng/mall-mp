  ...
  <view class="set-password">
    ...
    <view class="row flex-h flex-c-s m-0-40">
      ...
      <input
        ...
        type="text"
        maxlength="8"
        placeholder="请设置6-8位数字密码"
        placeholder-class="placeholder"
        :password="!showsPasswordText"
      />
      <image class="row__icon" :src="passwordIconURL" mode="scaleToFill" @click="showsPasswordText = !showsPasswordText" />
    </view>
    <view class="row flex-h flex-c-s m-0-40">
      ...
      />
      <image class="row__icon" :src="confirmPasswordIconURL" mode="scaleToFill" @click="showsConfirmPasswordText = !showsConfirmPasswordText" />
    </view>
    <button class="register-button fs-44 c-white" @click="handleRegisterClick">注册并登录</button>
  </view>
</template>
