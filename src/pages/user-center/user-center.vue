<template>
  <view class="user-center">
    ...
    <view class="user-info flex-h flex-c-s m-0-32">
      ...
      <view class="flex-v ml-32" v-if="userInfo.psnName">
        ...
        <text class="fs-36 c-black mt-16">
          {{ userInfo.idCard | idCardNumberFilter }}
        </text>
      </view>
      <view class="flex-v ml-32" v-else>
        <text class="fs-60 c-black">
          {{ userInfo.tel | phoneNumberFilter }}
        </text>
      </view>
    </view>
    <view class="list flex-v br-16">
      ...
      <view class="item flex-h flex-c-b pl-24 pr-12 bg-white" @click="handleModifyPhoneNumberClick">
        <image
          class="item__icon"
          mode="scaleToFill"
      ...
      <view class="item flex-h flex-c-b pl-24 pr-12 bg-white" @click="handleModifyPasswordClick">
        <image
          class="item__icon"
          mode="scaleToFill"
      ...
      <view class="item flex-h flex-c-b pl-24 pr-12 bg-white" @click="handleMessageCenterClick">
        <image
          class="item__icon"
          mode="scaleToFill"
      ...
      <view class="item flex-h flex-c-b pl-24 pr-12 bg-white" @click="handleFeedbackClick">
        <image
          class="item__icon"
          mode="scaleToFill"
      ...
      <view class="item flex-h flex-c-b pl-24 pr-12 bg-white" @click="handleLogoutClick">
        <image
          class="item__icon"
          mode="scaleToFill"
