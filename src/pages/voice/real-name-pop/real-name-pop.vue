  ...
  <view>
    <uni-popup ref="popup" :maskClick="maskClick" type="center">
      <view v-if="!showIdentity" class="popup">
        ...
        <image class="img-real" v-if="showImg" :src="headImg" mode="scaleToFill" />
        <canvas class="canvas" id="real-name-pop" canvas-id="real-name-pop"></canvas>
      ...
      <identity-info :showTop="showTop" v-if="showIdentity" :scanInfor="scan_info"
        @success_flag="success_flag" @closeModal="closeModal"></identity-info>
    </uni-popup>
    ...
    handleIdCode() {
      ...
      uni.chooseImage({
        ...
        success: (res) => {
          ...
          getLessLimitSizeImage('real-name-pop', file, 0.2, 750, (imagePath) => {
