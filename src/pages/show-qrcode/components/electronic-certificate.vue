  ...
  <view class="electronic-certificate">
    <view class="front-side m-32">
      <image
        ...
        mode="scaleToFill"
        src="http://192.168.1.187:10088/static/show-qrcode/icon-certificate-national-emblem.png"
      />
    ...
    <button class="manage-button fs-44 c-white" @click="handleManageButtonClick">证照管理</button>
