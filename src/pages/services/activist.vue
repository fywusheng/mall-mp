...
<template>
  <view class="activist">
    ...
    <view class="right-wrapper">
      <view v-for="item in rightList" :key="item.type" class="list-item"
    ...
    <pop-modal ref="confirmPop" cancelText='取消' title=" " confirmText='拨打电话'
      @confirm='handlConfirmPop' @cancel='handleCancel'>
      <view slot="text">
...
export default {
  data() {
    return {
      iconBg: 'https://ggllstatic.hpgjzlinfo.com/static/services/icon-activist-bg.png',
      rightList: [
        { url: 'https://ggllstatic.hpgjzlinfo.com/static/services/icon-right-1.png', type: 0, txt: '赡养抚养' },
        { url: 'https://ggllstatic.hpgjzlinfo.com/static/services/icon-right-2.png', type: 1, txt: '住房维权' },
        { url: 'https://ggllstatic.hpgjzlinfo.com/static/services/icon-right-3.png', type: 7, txt: '债权债务' },
        { url: 'https://ggllstatic.hpgjzlinfo.com/static/services/icon-right-4.png', type: 8, txt: '劳动仲裁' },
        { url: 'https://ggllstatic.hpgjzlinfo.com/static/services/icon-right-5.png', type: 2, txt: '婚姻自由' },
        { url: 'https://ggllstatic.hpgjzlinfo.com/static/services/icon-right-6.png', type: 3, txt: '消费权益' },
        { url: 'https://ggllstatic.hpgjzlinfo.com/static/services/icon-right-7.png', type: 4, txt: '土地承包' },
        { url: 'https://ggllstatic.hpgjzlinfo.com/static/services/icon-right-8.png', type: 5, txt: '集资诈骗' },
        { url: 'https://ggllstatic.hpgjzlinfo.com/static/services/icon-right-9.png', type: 6, txt: '医疗纠纷' },
        { url: 'https://ggllstatic.hpgjzlinfo.com/static/services/icon-right-10.png', type: 9, txt: '其他' }
      ],
      // 累计服务用户数
