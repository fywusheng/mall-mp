      ...
      <view class="notice">
        <view class="_center">
          <image class="_img" mode="scaleToFill"
            src="https://ggllstatic.hpgjzlinfo.com/static/rights/modalTop.png" />
        </view>
        <view class="_t">当前所在地区暂未开通该服务</view>
        <view class="_subt">正在开通中,敬请期待</view>
...
.notice {
  ...
  ._center {
    width: 100%;
    margin: 32rpx 118rpx 33rpx 118rpx;
  }
  ._img {
    width: 384rpx;
    height: 204rpx;
