    ...
    <view class="section flex-v p-32">
      ...
      <div class="panel-card">
        <view class="f-s-44 m-b-16">
          <!-- <text></text> -->
          <text
            v-if="dataDetail.infoDetail.social_service_contacts">联系人：{{ dataDetail.infoDetail.social_service_contacts }}</text>
        </view>
        <view class="m-b-16">
        ...
        <view class="t-grey p-address m-b-16">
          <text
            v-if="dataDetail.infoDetail.social_service_addr">商家地址：{{ dataDetail.infoDetail.social_service_addr}}</text>
        </view>
      ...
      <scroll-view class="images mt-24" :scroll-x="true" v-if="dataDetail.photoShop.length != 0">
        <image class="image mr-24 br-16" mode="scaleToFill" :src="item"
          @click="handleImageClick(dataDetail.photoShop)"
          v-for="(item, index) in dataDetail.photoShop" :key="index" />
      </scroll-view>
    </view>
  ...
  methods: {
    ...
    handlePhone() {
      ...
      if (this.dataDetail.scenic_service_tel) {
        const phoneNumber = this.dataDetail.scenic_service_tel.replace(
          /\//g,
          ','
        )
