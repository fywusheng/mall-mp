    ...
    <view class="footer bg-white">
      <view class="flex-h flex-c-c mt-16">
        ...
        >
          <image
            class="route"
            src="http://192.168.1.187:10088/static/services/icon-road.png"
            mode="scaleToFill"
          />
          <text>路线</text>
        </button>
        ...
        >
          <image
            class="phone"
            src="http://192.168.1.187:10088/static/services/icon-phone.png"
            mode="scaleToFill"
          />
          <text>电话</text>
        </button>
  ...
  export default {
    ...
    onShareAppMessage(res) {
      return {
        ...
        path: '/pages/services/address-detail?orgOfficeId=' + this.dataDetail.orgOfficeId,
      };
    },
    onShow() {
      // this.getCollect()
          ...
          success: (data) => {
            ...
            if (data.orgOfficeInfoDetail) {
              ...
              if (detail.social_service_photos) {
                this.dataDetail['photoShop'] = [...detail.social_service_photos.split(',')];
              }
    ...
    methods: {
      ...
      handlePhone() {
        ...
        if (this.dataDetail.social_service_tel) {
          const phoneNumber = this.dataDetail.social_service_tel.replace(/\//g, ',');
          phoneNumber.split(',').forEach((item) => {
