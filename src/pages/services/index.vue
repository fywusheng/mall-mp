<template>
  <view class="service">
    <view class="_topbg">
      <image
        class="img"
        src="http://192.168.1.187:10088/static/services/bgTopImg.png"
        mode="scaleToFill"
      />
    </view>
          ...
          <view class="page-main">
            ...
            >
              <view class="nav uni-nav">
                <view
                  class="nav-item"
                  :class="tab1Index == index ? 'nav-item-act' : ''"
                  :key="index"
            ...
            >
              <view class="nav uni-nav">
                <view
                  class="nav-item"
                  :class="currentIndex == index ? 'nav-item-act2' : 'classItem'"
                  :key="index"
            ...
            <view class="swiper">
              ...
              >
                <view
                  class="recommend-item flex-h flex-c-b"
                  v-for="(artItem, artIndex) in stashData[tab1Index + '_' + currentIndex]['list']"
                  :key="artIndex"
                  @click="handleServicesDetailClick(artItem)"
                >
                  <view class="content-all-left">
                    <image
                      class="img"
                      :src="artItem.social_service_photos"
                      @error="handleServiceLoadFail(index, artIndex)"
                      mode="aspectFill"
                    />
                  ...
                  <view class="content-all-right">
                    ...
                    <view class="flex-h flex-c-b">
                      <image
                        class="location"
                        src="http://192.168.1.187:10088/static/home/home-huilao-location.png"
                        mode="scaleToFill"
                      />
...
<script>
  ...
  export default {
    ...
    onPullDownRefresh() {
      ...
      this.currentPage = 1;
      this.nomore = false;
      this.stashData[this.tab1Index + '_' + this.currentIndex]['currentPage'] =
        this.stashData[this.tab1Index + '_' + this.currentIndex]['currentPage'] + 1;
      this.loadMore();
    ...
    methods: {
      ...
      handleServiceLoadFail(tabIndex, index) {
        this.list[index].social_service_photos =
