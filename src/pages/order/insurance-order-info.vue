  ...
  <view v-if="info" class="insurance-info">
    ...
    <view class="card top">
      <view class="item">
        ...
        <image v-if="info.insuStatus === 5" class="icon-status" :src="icon1" mode="scaleToFill" />
    ...
    <view class="card info">
      ...
      <view class="item">
        <view class="label">该保险产品由 <text class="company">泰康在线财险有限公司</text> 承保并提供如下服务</view>
      </view>
      <view class="service">
        <view class="service-item">
          <image src="https://ggllstatic.hpgjzlinfo.com/static/order/service-1.png" class="icon"
            mode="scaleToFill" />
          <view class="text">电子保单</view>
        </view>
        <view class="service-item">
          <image src="https://ggllstatic.hpgjzlinfo.com/static/order/service-2.png" class="icon"
            mode="scaleToFill" />
          <view class="text">申请理赔</view>
        </view>
        <view class="service-item">
          <image src="https://ggllstatic.hpgjzlinfo.com/static/order/service-3.png" class="icon"
            mode="scaleToFill" />
          <view class="text">电子发票</view>
        </view>
        <view class="service-item">
          <image src="https://ggllstatic.hpgjzlinfo.com/static/order/service-4.png" class="icon"
            mode="scaleToFill" />
    ...
    <view class="card info">
      ...
      <view class="item">
        ...
        <view class="info">{{info.ordInsuredDTO.name | desensitizeName}}</view>
      </view>
      <view class="item">
        <view class="label">身份证号</view>
        <view class="info">{{info.ordInsuredDTO.cardCode | desensitizeInfo}}</view>
      </view>
      <view class="item">
        <view class="label">手机号</view>
        <view class="info">{{info.ordInsuredDTO.telPhone | hidePhone}}</view>
      </view>
      <view class="item">
        <view class="label">与投保人关系</view>
        <view class="info">{{info.ordInsuredDTO.phRelation | formatRelation}}</view>
      </view>
    </view>
    <view class="card info">
      <view class="item">
    ...
    <view class="card info">
      ...
      <view class="item">
        ...
        <view class="info">{{info.ordStartDate| formateDate}}至{{info.ordEndDate|formateDate}}</view>
      </view>
