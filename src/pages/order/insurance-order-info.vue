  ...
  <view v-if="info" class="insurance-info">
    ...
    <view class="card info">
      ...
      <view class="service">
        <view class="service-item">
          <image
            src="http://192.168.1.187:10088/static/order/service-1.png"
            class="icon"
            mode="scaleToFill"
          />
        ...
        <view class="service-item">
          <image
            src="http://192.168.1.187:10088/static/order/service-2.png"
            class="icon"
            mode="scaleToFill"
          />
        ...
        <view class="service-item">
          <image
            src="http://192.168.1.187:10088/static/order/service-3.png"
            class="icon"
            mode="scaleToFill"
          />
        ...
        <view class="service-item">
          <image
            src="http://192.168.1.187:10088/static/order/service-4.png"
            class="icon"
            mode="scaleToFill"
          />
    ...
    <view class="card info">
      ...
      <view class="item">
        ...
        <view class="info">
          {{ info.ordStartDate | formateDate }}至{{ info.ordEndDate | formateDate }}
        </view>
      </view>
