<template>
  <view>
    ...
    <view class="top-warp">
      ...
      <me-tabs class="me-tabs" v-model="tabIndex" :tabs="tabs" @change="tabChange"></me-tabs>
    </view>

    <!-- top="xxx"下拉布局往下偏移,防止被悬浮菜单遮住 -->
    <mescroll-body ref="mescrollRef" @init="mescrollInit" top="120" @down="downCallback"
...
export default {
  ...
  components: { MeTabs, MescrollBody, AllOrder, ShopOrder, HotelOrder, NearOrder },
  data() {
    return {
      upOption: {
        // page: {
