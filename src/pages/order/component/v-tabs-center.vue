<template>
  <view :id="elId" class="v-tabs">
    <scroll-view id="scrollContainer" :scroll-x="scroll" :scroll-left="scroll ? scrollLeft : 0"
      ...
      :style="{ position: fixed ? 'fixed' : 'relative', zIndex: 888 }">
      <view v-if="tabs.length >0" class="v-tabs__container" :style="{
        ...
        <view class="v-tabs__container-item" :class="{active: current == i}" v-for="(v, i) in tabs"
          :key="i" :style="{
        ...
        <!-- <view v-if="!pills && tabs.length >0" class="v-tabs__container-line" :style="{
