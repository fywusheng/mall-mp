...
<template>
  <view class="content">
    <view v-if="loading == 2">
      ...
      <swiper class="swiper" :indicator-dots="false" :autoplay="false" :interval="4000"
        :duration="500" indicator-color="#E0E0E0" indicator-active-color="#FF5500"
        ...
        <swiper-item class="item" v-for="(artItem, artIndex) in list" :key="artIndex">
          ...
          <view @click="goDetail($event,index,artIndex)" :data-id="artItem.contId"
            ...
            <view class="noimg-bottom">
              ...
              <view class="right" @click.native.stop="handleNoimg(artItem,artIndex)">
                <image v-if="playIndex != artItem.contId"
                  src="https://ggllstatic.hpgjzlinfo.com/static/find/horn2x.png" mode="scaleToFill">
                </image>
                <template v-else>
                  <image v-if="mapState[artItem.contId]" class="playimg"
          ...
          <view @click="goDetail($event,index,artIndex)" :data-id="artItem.contId"
            ...
            <view class="img-center">
              <template v-for="(imgItem,imgIndex) in artItem.imgs">
                <image v-if="imgIndex>2?false:true" :src="imgItem" mode="scaleToFill"
          ...
          <!-- 视频模块-->
          <view @click="goVedio()" :data-id="artItem.contId" class="content-noimg"
      ...
      <uni-swiper-dot :info="list" :current="index" field="content" mode="round"
    ...
    <view class="audio" v-if="showAudio">
      <Yaudio @handleClose="handleClose" ref="yaudio" @prePlay="prePlay"
        @handleSwitchPlay="handleSwitchPlay" @nextPlay="nextPlay" :title="title"
        :stopPlay="stopPlay" :videoBg="videoBg" :closeAudio="closeAudio" @triggleBg="triggleBg">
      </Yaudio>
    </view>
