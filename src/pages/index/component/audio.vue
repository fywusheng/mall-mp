    ...
    >
      ...
      <view class="box-audio">
        <view class="control" @click="prePlay">
          <image src="http://192.168.1.187:10088/static/find/pre.png" mode="scaleToFill"></image>
          <text>上一条</text>
        </view>
        ...
        <view class="control" @click="nextPlay">
          <image src="http://192.168.1.187:10088/static/find/next.png" mode="scaleToFill"></image>
          <text>下一条</text>
        </view>
        <view class="control" @click="handleClose">
          <image src="http://192.168.1.187:10088/static/find/delete.png" mode="scaleToFill"></image>
          <text>关闭</text>
        </view>
      </view>
    </view>
...
<style lang="scss" scoped>
  ...
  .circle {
    ...
    width: 144rpx;
    height: 144rpx;
    background: url('http://192.168.1.187:10088/static/find/process_bg2x.png') no-repeat;
