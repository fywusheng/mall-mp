  ...
  <view>
    ...
    <view class="content">
      <view class="banner-wrapper" :style="{'margin-top': navHeight + 'px'}">
        <!-- banner -->
        <swiper class="banner-swiper" :indicator-dots="banners.length>1" :autoplay="true"
          ...
          <swiper-item class="item" v-for="(item, index) in banners" :key="index">
            <image class="image" mode="scaleToFill" :src="item.bannerUrl"
              @click="handleBannerClick(index)" @error="handleBannerLoadFail(index)" />
          </swiper-item>
        </swiper>
      </view>
      <!-- 积分兑换 -->
        ...
        <view class="benefit-top title-top flex-h flex-c-b" @click="goPath(0)">
          <view class="title-top-left flex-h flex-c-c">
            <view class="title-top-left-text _line">
              <view class="_leftLine"></view>积分兑换
            </view>
      ...
      <view class="mili ml-32 mr-32 mt-24 mb-48 br-16" @click="goMili()">
        <view class="benefit-top title-top flex-h flex-c-b">
          <view class="title-top-left flex-h flex-c-c">
            <view class="title-top-left-text _line">
              <view class="_leftLine"></view>消费养老
            </view>
            <view class="_more">更多</view>
          </view>
          <view>
      ...
      <view class="nearby-discount ml-32 mr-32 mt-24 mb-24 br-16">
        <view class="benefit-top title-top flex-h flex-c-b">
          <view class="title-top-left flex-h flex-c-c">
            <view class="title-top-left-text _line">
              <view class="_leftLine"></view>附近优惠
            </view>
          </view>
        </view>
        <view class="discount-img">
          <image src="https://ggllstatic.hpgjzlinfo.com/static/home/icon_nearby_discount.png"
            mode="scaleToFill" @click="handleSuperMarket" />
        </view>
      </view>
      <!-- 保险服务-->
      <view class="nearby-discount ml-32 mr-32 mt-24 mb-24 br-16" @click="goBaoXian">
        <view class="benefit-top title-top flex-h flex-c-b">
          <view class="title-top-left flex-h flex-c-c">
            <view class="title-top-left-text _line">
              <view class="_leftLine"></view>保险服务
            </view>
            <view class="_more">更多</view>
          </view>
        </view>
        <view class="bao-img">
          <image src="https://ggllstatic.hpgjzlinfo.com/static/home/bao_xian.png"
            mode="scaleToFill" />
        </view>
      </view>
      <!-- 为老地图-->
      <view class="nearby-discount ml-32 mr-32 mt-24 mb-24 br-16">
        <view class="benefit-top title-top flex-h flex-c-b">
          <view class="title-top-left flex-h flex-c-c">
            <view class="title-top-left-text _line">
              <view class="_leftLine"></view>为老地图
            </view>
          </view>
        </view>
        <view class="map-img" @click="handleMapClick">
          <image src="https://ggllstatic.hpgjzlinfo.com/static/home/map_old.png"
            mode="scaleToFill" />
        </view>
      </view>
    </view>
