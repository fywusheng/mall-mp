<template>
  <view class="auth">
    ...
    <view class="arguments">
      查看<text class="c-blue">《用户授权协议》</text><text class="c-blue">《电子老年人证用户协议》</text><text class="c-blue">《人脸识别认证服务须知》</text>，授权电子老年人证获取你的姓名、手机号、身份证用于实名领卡，并经由国家老龄服务平台上传您的相片、姓名、社会保障号码信息以完成实人认证。
    </view>
    <view class="page-bottom">
      <view class="flex-h flex-c-c">
        <image class="img-line"
