<template>
  <view class="auth">
    <view class="banner p-0-32">
      <image
        class="img"
        src="http://192.168.1.187:10088/static/certificate/auth-ban.png"
        mode="scaleToFill"
      />
      <view class="title flex-h flex-s-s">
        <image
          class="logo mr-16"
          src="http://192.168.1.187:10088/static/certificate/auth-logo.png"
          mode="scaleToFill"
        />
    ...
    <view class="btn-box mt-80 mb-32">
      <button class="agree-button fs-44 fw-bold c-white" @click="handleAgreeClick">
        同意协议并授权
      </button>
    </view>
    ...
    <view class="page-bottom">
      <view class="flex-h flex-c-c">
        <image
          class="img-line"
          src="http://192.168.1.187:10088/static/certificate/text-line-left.png"
          mode="scaleToFill"
        />
        <view class="line-text">电子老年人证服务</view>
        <image
          class="img-line"
          src="http://192.168.1.187:10088/static/certificate/text-line-right.png"
          mode="scaleToFill"
        />
      </view>
