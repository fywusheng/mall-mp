  ...
  <view class="applicant-info">
    <view class="form m-32">
      <view class="row flex-h flex-c-s p-20-0">
        ...
        <input class="fs-40 c-black flex-1" placeholder="请输入姓名" :adjust-position="false" placeholder-class="placeholder" v-model="params.name" />
      </view>
      <view class="row flex-h flex-c-s p-20-0">
        <text class="row__indicator">*</text>
      ...
      <view class="row flex-h flex-c-s p-20-0">
        ...
        <picker class="flex-1" mode="date" :end="validDate" :value="params.birthday" @change="handleBirthdayChange">
    ...
    <button class="next-step-button bg-primary fs-44 c-white" @click="handleNextStepClick">下一步</button>
  </view>
</template>
    ...
    methods: {
      ...
      handleFaceRecognitionFinish(result) {
        ...
        if (ismatch) {
          ...
          const request = isAuthenticated ? api.getFaceRecognitionResult : api.realPersonAuthenticate;
          request({
            data: {
