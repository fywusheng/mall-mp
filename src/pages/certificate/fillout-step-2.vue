<template>
  <view class="fillout-step-2">
    ...
    <view class="section" v-for="(item, index) in params.contactList" :key="index">
      ...
      <view class="section-footer" v-if="params.contactList.length > 1 && index === 0"></view>
    </view>
    <view
    ...
    >
      <image
        ...
        mode="scaleToFill"
        src="http://192.168.1.187:10088/static/common/icon-common-add-primary.png"
      />
    ...
    <view class="footer bg-white">
      ...
      <view class="actions flex-h flex-c-b mt-32">
        ...
        <button class="action fs-44 c-white bg-primary" @click="handleNextStepClick">下一步</button>
      </view>
    </view>
  </view>
</template>
