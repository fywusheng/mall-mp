<template>
  <view class="fillout-step-3">
      ...
      <view class="form">
        <view class="item p-0-32"
          ...
          <view class="row flex-h flex-c-b">
            ...
            <button class="see-example fs-36"
                    hover-class="none"
          ...
          <view v-else
                ...
                @click="handlePhotoPickerClick(index)">
            <image class="photo-picker__icon"
                   mode="scaleToFill"
          ...
          <button v-if="params.materials.length > 1"
    ...
    <button v-if="params.materials.length < materialTypes.length"
    ...
    <view class="footer bg-white">
      ...
      <view class="actions flex-h flex-c-b mt-32">
        <button class="action fs-44 c-primary bg-white border"
                @click="handlePreviousStepClick">
          上一步
        </button>
        <button class="action fs-44 c-white bg-primary"
