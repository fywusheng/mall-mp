  ...
  <view class="scan-result pt-32">
    <view class="container flex-v flex-c-s bg-white m-0-32">
      ...
      <image
        ...
        mode="scaleToFill"
        src="http://192.168.1.187:10088/static/certificate/icon-certificate-avatar.png"
      />
      <image
        class="success-icon"
        mode="scaleToFill"
        src="http://192.168.1.187:10088/static/certificate/icon-certificate-scan-success.png"
      />
      <view class="line" />
      <view class="info flex-v p-32">
        ...
        <view class="row flex-h flex-c-s mb-24">
          <text class="fs-36 c-black">姓名：{{ info.psn_name | nameFilter }}</text>
        </view>
        <view class="row flex-h flex-c-s mb-24">
          <text class="fs-36 c-black">身份证号：{{ info.psn_id | idCardNumberFilter }}</text>
        </view>
        <view class="row flex-h flex-c-s mb-24">
    ...
    <image
      class="signature"
      mode="scaleToFill"
      src="http://192.168.1.187:10088/static/certificate/icon-certificate-signature.png"
    />
