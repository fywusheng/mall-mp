  ...
  <view class="avatar-confirm flex-v flex-c-b">
    ...
    <view class="avatar flex-v flex-c-c mt-24">
      <image
        class="border-image"
        mode="scaleToFill"
        src="http://192.168.1.187:10088/static/certificate/bg-certificate-avatar-border.png"
      />
      <image v-if="avatarURL" mode="scaleToFill" class="avatar-image" :src="avatarURL" />
    </view>
    ...
    methods: {
            ...
            if (res.count < 0) {
              ...
              this.$uni.showAlert({
                ...
                confirm: () => {
                  ...
                  //#ifdef MP-ALIPAY
                  uni.setStorageSync('otherInfo', encodeURIComponent(JSON.stringify(info)));
                  uni.redirectTo({
      ...
      handleTakePhotoClick() {
        ...
        params.success = (getbase64) => {
          ...
          //   filePath: 'http://192.168.1.187:10088/static/certificate/05f08ce3a4c8ce77b5c0af61c35619c.jpg',
          //   encoding: 'base64',
          //   success: (res) => {
          //     this.clearBgImg(getbase64)
          //   },
