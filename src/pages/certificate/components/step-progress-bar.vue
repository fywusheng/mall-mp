<template>
  <view class="step-progress-bar flex-h flex-c-c">
    ...
    <view class="step flex-v flex-c-c flex-1" :class="{ 'step--highlight': step === 1 }">
      <image
        class="icon"
        mode="scaleToFill"
        src="http://192.168.1.187:10088/static/certificate/icon-certificate-step-finished.png"
        v-if="step > 1"
      />
      <text class="number fs-44 fw-500 c-white" v-else>1</text>
      <text class="title fs-36 mt-24">完善基本信息</text>
    </view>
    <view class="step flex-v flex-c-c flex-1" :class="{ 'step--highlight': step === 2 }">
      <image
        class="icon"
        mode="scaleToFill"
        src="http://192.168.1.187:10088/static/certificate/icon-certificate-step-finished.png"
    ...
    <view class="step flex-v flex-c-c flex-1" :class="{ 'step--highlight': step === 3 }">
      <image
        class="icon"
        mode="scaleToFill"
        src="http://192.168.1.187:10088/static/certificate/icon-certificate-step-finished.png"
