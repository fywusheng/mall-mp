...
<template>
  <view class="show-card">
    <view class="need-known bg-white" v-if="cardStatus == 3 || cardStatus == 2">
      <image
        class="need-img mb-8"
        src="http://192.168.1.187:10088/static/certificate/card-need-known.png"
        mode="widthFix"
      />
      <view class="text br-24">遵循自愿申领，即时办结的原则。需要申领电子老年人证的老年人。</view>
    </view>
    <view class="need-known bg-white br-24" v-if="cardStatus == 5">
      <image
        class="need-img mb-8"
        src="http://192.168.1.187:10088/static/certificate/card-fail.png"
        mode="widthFix"
      />
    ...
    <view class="need-known bg-white br-24" v-if="cardStatus == 4">
      <image
        class="need-img mb-8"
        src="http://192.168.1.187:10088/static/certificate/card-checking.png"
        mode="widthFix"
      />
      <view class="text fail-reason">
        <view class="flex-h flex-s-s mb-8 c-333">您的电子老年人证正在审核中</view>
        <view class="flex-h flex-s-s">
          <view class="label c-666">申领时间:</view>
          <view class="c-333" v-if="submitTime">{{ submitTime | dateFilter }}</view>
        </view>
    ...
    <view class="electronic-certificate" v-if="cardStatus == 1">
      <view class="front-side m-32">
        ...
        <text class="name-title fs-20">姓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名</text>
      ...
      <view class="back-side m-32">
        ...
        <text class="remark-title fs-20">备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注</text>
        ...
        <text class="copyright fs-16">中国老龄协会&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;制</text>
...
<script>
  ...
  export default {
    components: { ScanOrInputPopup, ActionSheet },
    props: {},
    data() {
      return {
  ...
  .show-card {
    ...
    .electronic-certificate {
      ...
      .back-side {
        ...
        position: relative;
        background: url('http://192.168.1.187:10088/static/certificate/bg-certificate-card.png');
        .national-emblem {
          @include size(90, 94);
          position: absolute;
          top: 34rpx;
