  ...
  <view class="additional-info">
    <view class="section">
      <view class="section-header flex-h flex-c-s p-0-32">
        <image
          ...
          mode="scaleToFill"
          src="http://192.168.1.187:10088/static/certificate/icon-certificate-basic-info.png"
        />
    ...
    <view class="footer bg-white">
      ...
      <view class="actions flex-h flex-c-b mt-32">
        <button class="action fs-44 c-primary bg-white border" @click="handlePreviousStepClick">
          上一步
        </button>
