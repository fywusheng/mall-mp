    ...
    <view class="section flex-v p-32">
      ...
      <view class="flex-h flex-c-s m-32-0">
        <image
          ...
          mode="scaleToFill"
        />
        <!-- <image class="star mr-12" src="http://192.168.1.187:10088/static/map/icon-star-full.png" />
        <image class="star mr-12" src="http://192.168.1.187:10088/static/map/icon-star-full.png" />
        <image class="star mr-12" src="http://192.168.1.187:10088/static/map/icon-star-full.png" />
        <image class="star mr-12" src="http://192.168.1.187:10088/static/map/icon-map-star-half.png" /> -->
        <!-- <xiao-star-component :starCount="1"/> -->
        <text class="fs-36 c-black ml-28">{{ dataDetail.infoDetail.scenic_area_score }}</text>
        <text class="fs-36 c-black ml-24">人均:{{ dataDetail.infoDetail.scenic_area_price }}</text>
      </view>
      <text class="fs-36 c-black">
        {{ dataDetail.distance }}｜{{ dataDetail.infoDetail.scenic_area_name }}
      </text>
      <view class="tags flex-h flex-c-s flex-wrap m-24-0">
        <text class="tag fs-32 c-white bg-primary mr-16 br-4">景点</text>
    ...
    <view class="section flex-v p-32">
      ...
      <view :class="['mt-24', heightClass]">
        <text class="content fs-36 c-black">
          {{
            textShow1
              ? dataDetail.infoDetail.scenic_area_intro
                ? dataDetail.infoDetail.scenic_area_intro
                : '暂无'
              : dataDetail.infoDetail.scenic_area_intro
              ? getString(dataDetail.infoDetail.scenic_area_intro)
              : '暂无'
          }}
        </text>
        <text
