<template>
  <view class="attraction-detail">
    <view class="section flex-v p-32">
      ...
      <view class="flex-h flex-c-s m-32-0">
        <image
          ...
          :key="index"
           mode="scaleToFill"
        />
        <!-- <image class="star mr-12" src="https://ggllstatic.hpgjzlinfo.com/static/map/icon-star-full.png" />
        <image class="star mr-12" src="https://ggllstatic.hpgjzlinfo.com/static/map/icon-star-full.png" />
        <image class="star mr-12" src="https://ggllstatic.hpgjzlinfo.com/static/map/icon-star-full.png" />
        <image class="star mr-12" src="https://ggllstatic.hpgjzlinfo.com/static/map/icon-map-star-half.png" /> -->
        <!-- <xiao-star-component :starCount="1"/> -->
        <text class="fs-36 c-black ml-28">{{
          dataDetail.infoDetail.scenic_area_score
        }}</text>
        <text class="fs-36 c-black ml-24"
          >人均:{{ dataDetail.infoDetail.scenic_area_price }}</text
        >
      </view>
      <text class="fs-36 c-black"
        >{{ dataDetail.distance }}｜{{
          dataDetail.infoDetail.scenic_area_name
        }}</text
      >
      ...
      <view class="actions flex-h flex-c-s">
        <view class="action flex-h flex-c-c mr-20 p-0-20" @click="handleMap">
          <image class="icon" src="https://ggllstatic.hpgjzlinfo.com/static/map/icon-map-location.png"  mode="scaleToFill"/>
          <text class="text fs-36 c-lightgrey ml-8">位置</text>
        </view>
        <view class="action flex-h flex-c-c mr-20 p-0-20" @click="handlePhone">
          <image class="icon" src="https://ggllstatic.hpgjzlinfo.com/static/map/icon-map-make-call-full.png" mode="scaleToFill" />
      ...
      <scroll-view
        class="images mt-24" mode="scaleToFill"
        :scroll-x="true"
        v-if="dataDetail.photoShop.length != 0"
      >
        <image
          class="image mr-24 br-16" mode="scaleToFill"
          :src="item"
    ...
    <view class="section flex-v p-32">
      <text class="section-title fs-40 fw-500 c-black">景点介绍</text>
      <view :class="['mt-24', heightClass]">
        <text class="content fs-36 c-black">
          {{
            textShow1
              ? (dataDetail.infoDetail.scenic_area_intro ? dataDetail.infoDetail.scenic_area_intro : '暂无')
              : (dataDetail.infoDetail.scenic_area_intro ? getString(dataDetail.infoDetail.scenic_area_intro) : '暂无') 
          }}
        </text>
        <text
          v-if="dataDetail.infoDetail.scenic_area_intro.length > 100"
    ...
    <view class="section flex-v p-32">
      <text class="section-title fs-40 fw-500 c-black">开放时间</text>
      <text class="content fs-36 c-black mt-24">
        {{ dataDetail.infoDetail.scenic_area_opentime }}
      </text>
    </view>
    <view class="section flex-v p-32">
    ...
    <view class="section flex-v p-32">
      ...
      <view :class="['mt-24', heightClass2]">
        <text class="content fs-36 c-black">
          {{
            textShow2
              ? (dataDetail.infoDetail.scenic_area_facility ? dataDetail.infoDetail.scenic_area_facility :'暂无')
              : (dataDetail.infoDetail.scenic_area_facility ? getString(dataDetail.infoDetail.scenic_area_facility) :'暂无') 
          }}
        </text>
        <text
          v-if="dataDetail.infoDetail.scenic_area_facility.length > 100"
          class="fs-36 text-position"
          style="color: #0059FF"
          @click="handleText(2)"
        >
      ...
      if (arr.length == 1) {
        switch (arr[0]) {
          ...
          case "1":
            this.rateList = [
              {
                url: "https://ggllstatic.hpgjzlinfo.com/static/map/icon-star-full.png",
              },
              {
                url: "https://ggllstatic.hpgjzlinfo.com/static/map/rate1_0.png",
              },
              {
                url: "https://ggllstatic.hpgjzlinfo.com/static/map/rate1_0.png",
              },
        ...
        switch (arr[0]) {
          ...
          case "1":
            this.rateList = [
              ...
              {
                url: "https://ggllstatic.hpgjzlinfo.com/static/map/icon-map-star-half.png",
              },
              {
                url: "https://ggllstatic.hpgjzlinfo.com/static/map/rate1_0.png",
              },
