<template>
  <view class="voice-input">
    <template v-if="shouldDisplay">
      <view class="mask animated" :style="{ background: 'rgba(0, 0, 0, ' + alpha + ')' }"
        @click="close" />
      <view class="panel animated bg-white flex-v" :style="{ height: height + 'rpx' }">
        ...
        <image class="icon mt-20" mode="scaleToFill"
          src="https://ggllstatic.hpgjzlinfo.com/static/common/icon-common-voice-input.png"
