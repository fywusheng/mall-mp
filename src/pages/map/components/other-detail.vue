    ...
    <view class="section flex-v p-32">
      ...
      <view :class="['mt-24', heightClass]">
        <text class="content fs-36 c-black">
          {{
            textShow1
              ? (dataDetail.scenic_area_intro ? dataDetail.scenic_area_intro :'暂无')
              : (dataDetail.scenic_area_intro ? getString(dataDetail.scenic_area_intro):'暂无') 
          }}
        </text>
        <text
