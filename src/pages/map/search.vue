    ...
    <template v-else>
        ...
        <view class="section-header flex-h flex-c-b">
          ...
          <view class="flex-h flex-c-c" @click="handleClearClick">
            <image
              class="clear-icon"
              mode="scaleToFill"
              src="http://192.168.1.187:10088/static/map/delete2x.png"
            />
      ...
      <view class="section m-32">
        ...
        <view class="list flex-h flex-wrap">
          ...
          <text
            class="item bg-white bt-8 mr-24 mt-24"
            @click="handleHotSearchItemClick('故宫博物馆')"
          >
            故宫博物馆
          </text>
          <text
            class="item bg-white bt-8 mr-24 mt-24"
            @click="handleHotSearchItemClick('八达岭长城')"
          >
            八达岭长城
          </text>
          <text
            class="item bg-white bt-8 mr-24 mt-24"
            @click="handleHotSearchItemClick('骏豪中央广场')"
          >
            骏豪中央广场
          </text>
        </view>
