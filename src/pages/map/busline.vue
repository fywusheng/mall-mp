  ...
  <view class="busline">
    ...
    >
      ...
      >
        ...
        <view v-for="(item, index) in buslines[selectedIndex].segments" :key="index">
          <!-- 步行信息 -->
            ...
            <view class="walking-info flex-h flex-c-s">
              <view class="icon flex-v flex-c-c">
                <image
                  class="walking-icon"
                  mode="scaleToFill"
                  src="http://192.168.1.187:10088/static/map/icon-map-walking.png"
                />
              </view>
              <text class="fs-36 c-lightgrey ml-12">步行{{ item.walking.distance }}</text>
            </view>
          </view>
          <!-- 公交信息 -->
            ...
            <view class="bus-info flex-h">
              <view class="icon flex-v flex-c-b">
                ...
                <image
                  ...
                  class="vehicle-icon"
                  mode="scaleToFill"
                  src="http://192.168.1.187:10088/static/map/icon-map-vehicle-subway.png"
                ...
                <image
                  ...
                  class="vehicle-icon"
                  mode="scaleToFill"
                  src="http://192.168.1.187:10088/static/map/icon-map-vehicle-bus.png"
                  :style="{ background: colors[index] }"
                />
                <view class="end-circle" :style="{ border: '4rpx solid ' + colors[index] }" />
              </view>
              <view class="flex-v ml-76">
                ...
                <view class="mt-16">
                  <text class="fs-36 c-white p-0-12 br-4" :style="{ background: colors[index] }">
  ...
  export default {
    ...
    computed: {
      ...
      polyline() {
        ...
        console.log('---polyline返回的值--', [
          { points: points, color: '#0078F7', width: 10, arrowLine: true },
        ]);
      ...
      indicatorIconPath() {
        ...
        const iconPath = 'http://192.168.1.187:10088/static/map/icon-map-arrow-upward.png';
