<template>
 <view class="hotelDetail">
      ...
      <view class="item">
       <view class="top">
           <view class="top_c">
                 ...
                 <view class="price" v-if="isShowPrice == 1 && item.hotelDiscountPrice">￥{{item.hotelDiscountPrice | formaterMoney}}</view>
           </view>
       </view>
       <view class="bottom">
           <view class="infor"><image src="https://ggllstatic.hpgjzlinfo.com/static/life/house.png" class="hourse"/><rich-text :nodes="strings"></rich-text></view>
           <view class="time"><image src="https://ggllstatic.hpgjzlinfo.com/static/life/time.png" class="hourse"/>{{item.hotelDiscountValidity}}</view>
       </view>
     </view>
     ...
     <view class="content">
         <image v-if="type == 1" class="bgimg" :src="url" v-for="(url,index) in picConent" :key="index" mode="widthFix"/>   
         <view v-if="type == 2"><right :hotelDiscountId="hotelDiscountId"></right></view>
         <view class="heightBootm" v-if="isShowPrice == 1"></view>
     </view>
     <view class="bottom_fix" v-if="isShowPrice == 1">
         <view class="btn" @click="buy"><image class="icon" src="https://ggllstatic.hpgjzlinfo.com/static/life/buyBtn.png" mode="widthFix"/></view>
     </view>
