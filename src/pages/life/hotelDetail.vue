  ...
  <view class="hotelDetail">
      ...
      <view class="top">
        <view class="top_c">
          ...
          <view class="price" v-if="isShowPrice == 1 && item.hotelDiscountPrice">
            ￥{{ item.hotelDiscountPrice | formaterMoney }}
          </view>
        </view>
      </view>
      <view class="bottom">
        <view class="infor">
          <image src="http://192.168.1.187:10088/static/life/house.png" class="hourse" />
          <rich-text :nodes="strings"></rich-text>
        </view>
        <view class="time">
          <image src="http://192.168.1.187:10088/static/life/time.png" class="hourse" />
    ...
    <view class="bottom_fix" v-if="isShowPrice == 1">
      <view class="btn" @click="buy">
        <image
          class="icon"
          src="http://192.168.1.187:10088/static/life/buyBtn.png"
          mode="widthFix"
        />
      </view>
    </view>
