    ...
    <view class="_bottom">
      <view class="swiper-item">
        <!-- <view class="map-icon" @click="handleAnimation">
                <image mode="scaleToFill" src="http://192.168.1.187:10088/static/map/icon-map-arrow-upward.png"/>
              </view> -->
        <view class="item3">
          <view class="top">
            <view class="img_qy">
              <image :src="transformData.hotelPhoto" class="bgimg" mode="scaleToFill" />
              <!-- <image src="http://192.168.1.187:10088/static/home/image-home-article-default.png" class="bgimg" mode="widthFix"/> -->
            </view>
            <view class="top_c">
