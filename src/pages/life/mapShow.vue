               ...
               <!-- <view class="map-icon" @click="handleAnimation">
                <image mode="scaleToFill" src="https://ggllstatic.hpgjzlinfo.com/static/map/icon-map-arrow-upward.png"/>
                 ...
                 <view class="item3">
                    <view class="top">
                        <view class="img_qy">
                          <image  :src="transformData.hotelPhoto" class="bgimg" mode="scaleToFill"/>
                        ...
                        <view class="top_c">
                              ...
                              <view class="time">住宿 | {{transformData.distance | setDistance}}</view>
...
export default {
  ...
  onLoad(e) {
     ...
     if(params){
       ...
       //#ifdef MP-ALIPAY
        this.markers = [{width:'60',height:'60',label:{content:this.transformData.name,bgColor:'#fff',color:'#333',padding:12,fontSize:16,borderRadius:8},latitude:this.transformData.latitude,longitude:this.transformData.longitude,iconPath:'https://ggllstatic.hpgjzlinfo.com/static/life/marker-icon8.png'}]
       //#endif
       //#ifdef MP-WEIXIN
       this.markers = [{width:'60',height:'60',callout:{bgColor:'#fff',color:'#333',padding:'8',fontSize:'16',borderRadius:'8',content:this.transformData.name,display:'ALWAYS'},latitude:this.transformData.latitude,longitude:this.transformData.longitude,iconPath:'https://ggllstatic.hpgjzlinfo.com/static/life/marker-icon8.png'}]
       //#endif
     } 
  },
  onReady() {
