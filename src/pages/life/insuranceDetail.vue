<template>
 <view class="insurance">
    ...
    <rich-text type="text" class="_center" :nodes="insuranDetal" @click="showNotice"></rich-text>
    <view class="bottom">
      <view class="_left"><view class="money">￥{{prices.split('/')[0]}}</view><view class="danwei"></view></view>
