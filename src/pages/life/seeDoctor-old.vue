<template>
  <view class="topArea">
    ...
    <view>
      ...
      <view>
        <view class="bg">
          <image class="topIcon" src="http://192.168.1.187:10088/static/life/doc_bg_top4.png" mode="scaleToFill" />
        </view>
...
<style lang="scss" scoped>
  .topArea {
    ...
    ._position {
      ...
      width: 686rpx;
      height: 226rpx;
      background-image: url(http://192.168.1.187:10088/static/life/doc_bg_icon.png);
