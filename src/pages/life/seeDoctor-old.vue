<template>
 <view class="topArea">
      ...
      <view>
        ...
        <view >
            <view class="bg">
                    <image class="topIcon" src="https://ggllstatic.hpgjzlinfo.com/static/life/doc_bg_top4.png" mode="scaleToFill"/>
            </view> 
            <view class="_position">
                <view class="_top">
                    <view class="top_item" v-for="(item,index) in items" :key="index" @click="handlerClick(item)">
            ...
            <view class="next">
                <view class="special"><view class="left_line"></view><view class="text">临床科室</view></view>
                <view class="_top _item">
                        <view v-for="(item,index) in centerList" :key="index" class="_row">
                            <view class="top_item no_top"  @click="goDetail(v)" v-for="(v,i) in item" :key="i">
