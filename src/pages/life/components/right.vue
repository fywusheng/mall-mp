            ...
            <view class="top_c">
              ...
              <view class="price">
                ...
                <view class="right" @click.stop="goMap(item)">
                  <view class="li">|</view>
                  <view class="icon">
                    <image class="im" src="http://192.168.1.187:10088/static/life/micon.png" mode="scaleToFill" />
                  </view>
  ...
  export default {
    ...
    methods: {
      goDetail(item) {
        ...
        uni.redirectTo({
          url: '/pages/life/hotelHomeDetail?params=' + `${encodeURIComponent(JSON.stringify(params))}`,
        });
      },
      goMap(item) {
        const params = {
