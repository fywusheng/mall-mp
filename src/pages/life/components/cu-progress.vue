<template>
  <view>
    <view
      ...
      :style="{'border-radius':bgBR,'width': progressMainW,'height':progressMainH,'background-color': backgroundColor}"
    >
      ...
      >
        <view
          ...
          :style="{'bottom':pgBarBottom,'background':pgBarBg,'margin-left':pgBarML, 'margin-bottom':pgBarMB,'width': pgBarW,'height':pgBarH,'border-radius':pgBarBR,'background-color':noActiveColor}"
        ></view>
        <movable-area
          class="cu-area"
        ...
        >
          <movable-view
            ...
            disabled="disabled"
            :animation="false"
            :style="{ 'top': handleT, 'width':handleW,'height':handleS,'border-radius': handleBR,'background-color':handleColor}"
            @change="change"
            :damping="damping"
            :x="handleX"
            :y="handleYF"
          ...
          >
            <image
              class="icon"
              src="https://ggllstatic.hpgjzlinfo.com/static/find/currentTime.png"
              mode="scaleToFill"
            />
            <text
              :class="handleIcon"
