<template>
  <view class="bugshopping">
    <view class="top" @click="show">
      <image
        class="topbg"
        src="http://192.168.1.187:10088/static/life/buy_top.png"
        mode="scaleToFill"
      />
    </view>
    <view class="_center" @click="show">
      ...
      <image
        class="top_c"
        src="http://192.168.1.187:10088/static/life/buy_top_c.png"
        mode="scaleToFill"
      />
    </view>
    <view class="_center_p" @click="show">
      <image
        class="top_p"
        src="http://192.168.1.187:10088/static/life/buy_top_p.png"
        mode="scaleToFill"
      />
    </view>
    <view class="_bottom">
        ...
        <view class="item" v-for="(item, i) in list" :key="i" @click="show">
          ...
          <view class="bottom">
            ...
            <view class="price">
              ...
              <view class="_right">
                <image class="righ_icon" src="http://192.168.1.187:10088/static/life/add.png" />
              </view>
            </view>
          </view>
        </view>
