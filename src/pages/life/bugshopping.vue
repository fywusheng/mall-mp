<template>
 <view class="bugshopping">
     <view class="top" @click="show">
         <image class="topbg" src="https://ggllstatic.hpgjzlinfo.com/static/life/buy_top.png" mode="scaleToFill"/>
     </view>
     <view class="_center" @click="show">
         ...
         <image class="top_c" src="https://ggllstatic.hpgjzlinfo.com/static/life/buy_top_c.png" mode="scaleToFill"/>
     </view>
     <view class="_center_p" @click="show">
         <image class="top_p" src="https://ggllstatic.hpgjzlinfo.com/static/life/buy_top_p.png" mode="scaleToFill"/>
     </view>
     <view class="_bottom">
           ...
           <view class="item" v-for="(item,i) in list" :key="i" @click="show">
               ...
               <view class="bottom">
                   ...
                   <view class="price">
                     ...
                     <view class="_right"><image class="righ_icon" src="https://ggllstatic.hpgjzlinfo.com/static/life/add.png"/></view>
                   </view>
               </view>
           </view>
        </view>
