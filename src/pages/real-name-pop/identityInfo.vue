...
<template>
  <view class="identity-info">
    ...
    <!-- #ifdef MP-ALIPAY -->
    <button class="next-step-button bg-cancel fs-44 c-white" @click="handleBack">关闭</button>
    <!-- #endif -->
                ...
                api.checkLogOutUser({
                  ...
                  success: (data) => {
                    ...
                    if (!data) {
                      ...
                      uni.navigateTo({
                        url: `/pages/user-center/real-name-result2?back=${'/pages/index/index'}&index=4`,
                      });
                    }
                  },
                });
