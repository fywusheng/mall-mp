<template>
  <view class="index">
    ...
    <view class="item bg-white br-16"
          @click="handleSeeDetailClick('allowance')">
      <view class="header flex-h flex-c-b p-0-32">
    ...
    <view class="item bg-white br-16"
          @click="handleSeeDetailClick('consumption')">
      <view class="header flex-h flex-c-b p-0-32">
    ...
    <view class="item bg-white br-16"
          @click="handleSeeDetailClick('policy')">
      <view class="header flex-h flex-c-b p-0-32">
      ...
      <view class="p-32">
        <view class="flex-h flex-c-b">
          <rich-text class="fs-36 c-black"
                     :nodes="description"></rich-text>
          <!-- <text class="fs-36 c-black">
            您享有
      ...
      <view class="p-32">
        <view class="functions flex-h flex-c-b ">
          <view class="left flex-v p-32 br-16">
            ...
            <view class="button flex-h flex-c-c mt-24 br-8"
                  @click="handleExaminationReserveClick">
              <text class="fs-36 c-white">预约体检</text>
              <image class="triangle-icon ml-16"
               mode="scaleToFill" 
          ...
          <view class="right flex-v p-32 br-16">
            ...
            <view class="button flex-h flex-c-c mt-24 br-8"
                  @click="handleOnlineInquiryClick">
    ...
    <uni-popup class="popup"
      ...
      <view class="card flex-v br-16 bg-white p-0-24">
        ...
        <view class="info flex-h">
          <image class="avatar" :src="doctor.headPortrait" mode="scaleToFill"    @error="handleHeadLoadFail"/>
          <view class="flex-v ml-24">
            ...
            <text class="hospital fs-36 c-black mt-24"  v-if="doctor.hospital">{{doctor.department}} {{doctor.hospital}}</text>
        ...
        <view class="make-call-button flex-h flex-c-c"
              @click.stop="handleMakeCallClick">
          <image class="phone-icon" mode="scaleToFill" 
                 src="https://ggllstatic.hpgjzlinfo.com/static/map/icon-map-make-call-white.png" />
...
export default {
 ...
 onShareAppMessage() {
  ...
  methods: {
    ...
    handleHeadLoadFail() {
      // 图片加载失败时显示默认图片
      // this.doctor.headPortrait = require("https://ggllstatic.hpgjzlinfo.com/static/common/icon-common-logo-watermark.png");
    },
    /**
     * 查看明细点击事件
     */
    ...
    getStateIconURL(index) {
      const showIcon = 'https://ggllstatic.hpgjzlinfo.com/static/user-center/icon-user-center-show-password.png'
      const hideIcon = 'https://ggllstatic.hpgjzlinfo.com/static/user-center/icon-user-center-hide-password.png'
      const isShow = [ this.showsAnnuityValue, this.showsAllowanceValue, this.showsBalanceValue][index]
