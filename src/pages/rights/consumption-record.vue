<template>
  <view class="consumption-record">
    <view class="filters flex-h flex-c-b bg-white">
      ...
      <picker range-key="text" :range="cities" @change="handleTypeChange2">
        <view class="filter flex-h flex-c-c flex-1">
          <text class="fs-36 c-black">
      ...
      <picker range-key="text" :range="types" @change="handleTypeChange">
        <view class="filter flex-h flex-c-c flex-1">
          <text class="fs-36 c-black">
      ...
      <picker :range="years" :value="yearIndex" @change="handleYearChange">
        <view class="filter flex-h flex-c-c flex-1">
      ...
      <view class="water_img">
        <view class="card m-32 br-16 bg-white">
          ...
          <view class="illustration p-32 flex-h">
            <view
              class="item flex-1 flex-v flex-c-b"
              v-if="params.type.value === '0' || params.type.value === '1'"
            >
            ...
            <view
              class="item flex-1 flex-v flex-c-b"
              v-if="params.type.value === '0' || params.type.value === '2'"
            >
              <view class="percent flex-h flex-c-c">
            ...
            <view
              class="item flex-1 flex-v flex-c-b"
              v-if="params.type.value === '0' || params.type.value === '3'"
            >
              <view class="percent flex-h flex-c-c">
        ...
        <view class="card m-32 br-16 bg-white" v-for="(item, index) in list" :key="index">
          <view class="header">
...
<style lang="scss" scoped>
  .consumption-record {
    ...
    .water_img {
      .card {
        background-image: url('http://192.168.1.187:10088/static/rights/bgwater2.png');
