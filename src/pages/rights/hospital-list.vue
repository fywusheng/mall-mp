<template>
  <view class="hospital-list">
    ...
    <template v-if="list.length > 0">
      <view class="list">
        <view class="item flex-v mt-24 bg-white"
              @click="handleItemClick()">
          <view class="flex-h">
            <!-- <image class="photo" src="https://ggllstatic.hpgjzlinfo.com/static/logo.png" /> -->
            <image class="photo"
                   mode="scaleToFill"
            ...
            <view class="flex-v ml-16">
              <text class="text fs-40 fw-500 c-black"
                    v-if="item.name">
                {{ item.name }}
              </text>
              <text class="text fs-36 fw-400 c-black mt-16"
                    v-if="item.distance">
                距离您 {{ item.distance }}
              </text>
              <text class="text fs-36 fw-400 c-black mt-16"
                    v-if="item.hospital_clinic">
          ...
          <view class="flex-h flex-c-b mt-24">
            ...
            <view class="route-button flex-h flex-c-c"
                  @click.stop="handleDirectionClick(item)">
              <image class="icon"
                     src="https://ggllstatic.hpgjzlinfo.com/static/map/icon-map-route.png"
                     mode="scaleToFill" />
              <text class="fs-36 fw-500 c-primary ml-8">路线</text>
            </view>
            <button class="reserve-button fs-36 fw-500 c-white"
