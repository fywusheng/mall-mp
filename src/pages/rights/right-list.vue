<template>
  <view class="right-list">
    <view class="banner m-32">
      <image class="image" mode="scaleToFill" src="https://ggllstatic.hpgjzlinfo.com/static/rights/banner-rights-introduce.png" />
      <view class="buttons flex-h flex-c-b p-0-16">
        <button class="button br-8 fs-32" @click="handleButtonClick(0)">
          敬老优待
        </button>
        <button class="button br-8 fs-32" @click="handleButtonClick(1)">
          养老保障
        </button>
        <button class="button br-8 fs-32" @click="handleButtonClick(2)">
          养老服务
        </button>
        <button class="button br-8 fs-32" @click="handleButtonClick(3)">
          医疗保障
        </button>
      </view>
    </view>
    <view class="list">
      <view class="item m-32 br-8" @click="jumpPage(item.path)" v-for="(item, index) in list" :key="index">
        ...
        >
          ...
          <image
            class="accessory" mode="scaleToFill"
            src="https://ggllstatic.hpgjzlinfo.com/static/common/icon-common-arrow-rightward-grey.png"
          />
        </view>
      </view>
  ...
  methods: {
    ...
    setData() {
      this.list = [
        ...
        {
          title: "免费体检",
          items: [{ title: "预约体检" ,path:"/pages/rights/consumption-record"}, { title: "健康档案" }],
        },
        {
          title: "家庭医生",
