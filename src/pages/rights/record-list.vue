  ...
  <view class="record-query">
    ...
    <view class="header bg-white">
      <!-- <image class="card-background" mode="scaleToFill"
             src="https://ggllstatic.hpgjzlinfo.com/static/rights/bg-rights-bank-card.png" /> -->
      <image class="card-background" mode="scaleToFill"
             src="https://ggllstatic.hpgjzlinfo.com/static/rights/icon-card-bg.png" />
           ...
           <text class="fs-36 fw-500 c-black">北京市人力资源和社会保障厅</text>
            <view class="flex-h mt-40">
              <image class="avatar" mode="scaleToFill"
                    :src="basicInformation.headPortrait" />
               <view class="flex-v ml-32">
                <view class="row flex-h flex-c-s mb-24">
                  <text class="row-title fs-28">姓名：</text>
                  <text class="row-value fs-28 c-black">{{basicInformation.name | nameFilter}}</text>
                </view>
                <view class="row flex-h flex-c-s mb-24">
                  <text class="row-title fs-28">社会保障号码：</text>
                  <text class="row-value fs-28 c-black">{{basicInformation.socSecuNum |carteVitalFilter}}</text>
                </view>
                <view class="row flex-h flex-c-s mb-24">
            ...
            <view class="flex-h flex-c-s mt-28">
              <image class="bank-icon" mode="scaleToFill"
                    src="https://ggllstatic.hpgjzlinfo.com/static/rights/icon-rights-bank-boc.png" />
              <text class="fs-40 fw-400 c-black ml-32">卡号：{{basicInformation.bottomCardNum | bankCrardFilter}}</text>
            </view>
        </view> 
      </view>
      ...
      >
        ...
        <picker class="flex-1"
          ...
          <view class="filter flex-h flex-c-c">
            ...
            <image class="triangle-icon ml-12" mode="scaleToFill"
                   src="https://ggllstatic.hpgjzlinfo.com/static/common/icon-common-triangle-downward-black.png" />
          </view>
        </picker>
    </view>   
    ...
    init() {
      ...
      api.getIndividualRights({
        ...
        success: (res) => {
          ...
          //数据处理
        //养老金
        let yanglao = res.pension
        //固定2021
        let cityTypeY =  yanglao['2021']
        let citysY = []
        ...
        //高龄津贴
        let gaoling = res.ageAllowance
        let cityeGL = gaoling['2021']
        let cityGL = []
...
.record-query {
  ...
  .header {
    ...
    .card {
      ...
      position: relative;
      .bgWater{
        // background-image: url('https://ggllstatic.hpgjzlinfo.com/static/rights/bgWater.png');
