...
export default {
  data() {
    return {
      tabClickIndex: '',
      icon: 'https://ggllstatic.hpgjzlinfo.com/static/rights/icon-older-allowance.png',
      iconBottom: 'https://ggllstatic.hpgjzlinfo.com/static/rights/icon-zixun.png',
      tabArry: [
        'https://ggllstatic.hpgjzlinfo.com/static/rights/icon-tab1.png',
        'https://ggllstatic.hpgjzlinfo.com/static/rights/icon-tab2.png',
        'https://ggllstatic.hpgjzlinfo.com/static/rights/icon-tab3.png'
      ],
      tabList: [
        { name: '高龄津贴', value: '0' },
        { name: '失能老人补贴', value: '1' },
