<template>
  <view class="audio">
    ...
    <view class="circle" @click="triggle">
      ...
      <view class="black">
        <image v-if="stopPlay" mode="scaleToFill" src="https://ggllstatic.hpgjzlinfo.com/static/find/audio_gif.gif"></image>
        <image v-if="!stopPlay"  mode="scaleToFill"  src="https://ggllstatic.hpgjzlinfo.com/static/find/audio-stop2x.png"></image>
      </view>
    </view>
    <view class="box" :style="{'width': closeAudio ? '0rpx' : '87vw','paddingLeft':closeAudio ? '0rpx' : '150rpx'}">
      ...
      <view class="box-audio">
        <view class="control" @click="prePlay">
          <image src="https://ggllstatic.hpgjzlinfo.com/static/find/pre.png"  mode="scaleToFill"></image>
          <text>上一条</text>
        </view>
        <view class="control" @click="handleSwitchPlay">
          <image v-if="!stopPlay"  mode="scaleToFill" src="https://ggllstatic.hpgjzlinfo.com/static/find/play.png"></image>
          <image v-if="stopPlay" mode="scaleToFill" src="https://ggllstatic.hpgjzlinfo.com/static/find/stop.png"></image>
          <text>播放</text>
        </view>

        <view class="control"  @click="nextPlay">
          <image src="https://ggllstatic.hpgjzlinfo.com/static/find/next.png"  mode="scaleToFill"></image>
          <text>下一条</text>
        </view>
        <view class="control" @click="handleClose">
          <image src="https://ggllstatic.hpgjzlinfo.com/static/find/delete.png"  mode="scaleToFill"></image>
          <text>关闭</text>
        </view>
      </view>
    </view>
...
.circle{
  ...
  width: 144rpx;
  height: 144rpx;
  background: url("https://ggllstatic.hpgjzlinfo.com/static/find/process_bg2x.png") no-repeat;
