  ...
  <view class="small_video_class">
    <view class="top_header">
      ...
      <image
        ...
        mode="scaleToFill"
        @error="defaultImg"
        src="http://192.168.1.187:10088/static/find/head_icon.png"
      />
      <view>
    ...
    <view class="type_center">
      <small-video :datalist="list[0]" :showBottom="false" @return_data="reurnData"></small-video>
    </view>
    <view v-if="loading != 2">
      ...
      <view class="flex-v flex-c-c" v-if="loading == 3">
        <image
          class="noData"
          src="http://192.168.1.187:10088/static/find/no-data.png"
          mode="scaleToFill"
        />
        <view class="flex-c-c status-text">{{ loading_test[loading] }}</view>
      </view>
