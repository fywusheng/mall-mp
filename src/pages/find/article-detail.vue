      ...
      <view class="audio-content flex-c-c">
        ...
        <view class="right">
          <view class="flex-h flex-c-c article-content" @click.native.stop="handleNoimg()">
            ...
            <image v-if="play && !paused" class="playimg" mode="scaleToFill" src="http://192.168.1.187:10088/static/find/list-stop2x.png"></image>
            <image v-if="play && paused" class="playimg" mode="scaleToFill" src="http://192.168.1.187:10088/static/find/list-play2x.png"></image>
