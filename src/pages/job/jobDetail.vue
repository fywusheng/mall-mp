    ...
    <view v-if="jobContent.postName">
      <view class="top">
        <view class="t">
          ...
          <view class="p">
            {{jobContent.wagesMin /1000}}-{{jobContent.wagesMax /1000}}k·{{jobContent.wagesMonth || 12}}薪
          </view>
        </view>
        <view class="year">
          <view class="base">
            <image mode="scaleToFill"
              src="https://ggllstatic.hpgjzlinfo.com/static/home/location.png" />
            <view class="name">{{jobContent.cityName}}</view>
          </view>
          <view class="base">
            <image mode="scaleToFill"
              src="https://ggllstatic.hpgjzlinfo.com/static/home/work.png" />
            <view class="name">{{jobContent.workExperience}}年</view>
          </view>
          <view class="base">
            <image mode="scaleToFill" src="https://ggllstatic.hpgjzlinfo.com/static/home/mz.png" />
        ...
        <view class="tel_person">
          ...
          <image v-else mode="scaleToFill"
            src="https://ggllstatic.hpgjzlinfo.com/static/home/header.png" />
          <view class="person">{{jobContent.linkman}}</view>
        </view>
      </view>
      <view class="descript">
        <view class="title">
          <image src="https://ggllstatic.hpgjzlinfo.com/static/home/jx.png"></image>
