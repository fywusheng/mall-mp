  ...
  <view class="search">
    <view class="_search">
      <view class="search-header _left">
        ...
        <view class="_right" @click="searchBykey">搜索</view>
      </view>
    </view>
    <view class="recond_search" v-if="searchHistory.length > 0">
      <view class="line">
        ...
        <view class="r" @click="clearData">
          <image src="http://192.168.1.187:10088/static/home/del.png"></image>
          <view class="qk">清空</view>
        </view>
      </view>
      <view class="history">
        <view class="item" @click="goSearch(v)" v-for="(v, i) in searchHistory" :key="i">
          {{ v }}
        </view>
      </view>
    </view>
    ...
    <view class="bottom">
      <image
        ...
        src="http://192.168.1.187:10088/static/home/yuyin.png"
      ></image>
...
<style lang="scss" scoped>
  ...
  .search {
    ...
    .bottom {
      ...
      width: 100%;
      height: 178rpx;
      background-image: url('http://192.168.1.187:10088/static/home/voice_bj.png');
