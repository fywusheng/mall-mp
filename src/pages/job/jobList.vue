  ...
  <view class="job">
    <view class="_search">
      <view class="_left" @click="handleCityClick">
        ...
        <image mode="scaleToFill" src="https://ggllstatic.hpgjzlinfo.com/static/home/up.png" />
      </view>
      <view class="search-header">
        <img class="icon" src="https://ggllstatic.hpgjzlinfo.com/static/images/common/ss.png">
        <input confirm-type="search" disabled @click="focusInput" :placeholder="key || '搜职位'"
          v-model="key">
      ...
      <view class="_right" @click="jobType">
        <image src="https://ggllstatic.hpgjzlinfo.com/static/home/jobAll.png"></image>
