  ...
  <div class="checkout-coupon">
    ...
    <template v-if="status === 0">
      ...
      <div class="empty-wrap" v-if="status === 0 && !canuseList.length">
        <img class="icon-empty" src="http://192.168.1.187:10088/static/images/common/icon-empty.png" />
      </div>
    </template>
  ...
  .checkout-coupon {
    ...
    .coupon-list {
      ...
      .coupon {
        ...
        width: rpx(693);
        min-height: rpx(232);
        background: url(http://192.168.1.187:10088/static/images/order/icon-enabled.png) left top no-repeat;
