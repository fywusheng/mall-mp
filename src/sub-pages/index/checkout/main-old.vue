        ...
        <template v-for="(item, subIndex) in store.settlementItems">
          <li class="item" :key="subIndex">
            <div
              class="item-logo"
              :style="{
                backgroundImage: 'url(' + (item.skuImgUrl ? item.skuImgUrl : item.mainImgUrl) + ')',
              }"
            ></div>
          ...
          <div class="point-wrap" :key="subIndex">
            <view class="use-point">
              ...
              <div class="use-point">
                ...
                分，可抵
                <text class="point">¥{{ item.discountScore * item.quantity }}</text>
              </div>
            </view>
          </div>
        </template>
    ...
    <div class="checkout-footer">
      ...
      <view class="left">
        <div class="total">
          实付:
          <span class="unit">¥</span>
          <span class="total-price">{{ settlement.totalPayablePrice | formateNum }}</span>
        </div>
      </view>
      <button
        type="button"
