  ...
  <div class="page-invoice" :class="{ isIphoneHair }">
    <div class="info-wrap">
      ...
      <ul class="invoice-type">
        <li
          class="type"
          @tap="changeInvoiceType(0)"
          :class="invoice.invoiceType == 0 ? 'active' : ''"
        >
          电子普通发票
        </li>
        <li
          class="type"
          @tap="changeInvoiceType(1)"
          :class="invoice.invoiceType == 1 ? 'active' : ''"
        >
          增值专用发票
        </li>
      </ul>
    ...
    <div class="info-wrap invoice-title-wrap">
      ...
      <template v-if="invoice.invoiceType == 0">
        <ul class="invoice-type">
          <li
            class="type"
            @tap="changeApplicantType(0)"
            :class="{ active: invoice.applicantType == 0 }"
          >
            个人
          </li>
          <li
            class="type"
            @tap="changeApplicantType(1)"
            :class="{ active: invoice.applicantType == 1 }"
          >
            公司
          </li>
        </ul>
      ...
      <div class="company-info" v-if="invoice.applicantType == 1 || invoice.invoiceType == 1">
        ...
        <input
          type="text"
          v-model="invoice.identifyingCode"
          maxlength="20"
          class="form-control"
      ...
      <template v-if="invoice.invoiceType == 1">
        ...
        <input
          type="text"
          v-model="invoice.registrationAddress"
          maxlength="64"
          class="form-control"
        ...
        <input
          type="text"
          v-model="invoice.registrationPhone"
          maxlength="11"
          class="form-control"
      ...
      <template v-if="invoice.invoiceType == 0">
        ...
        <input
          type="text"
          v-model="invoice.recipientPhone"
          maxlength="11"
          class="form-control"
