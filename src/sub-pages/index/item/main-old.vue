    ...
    <template v-else>
      ...
      <ul class="info-list">
        ...
        <li class="info">
          ...
          <!-- 全免包邮 -->
          <view v-if="freight.isPostage === 1 && freight.postage === 0" class="font_value">
            商家包邮
          </view>
          <!-- 满X元包邮 -->
          <view
          ...
          <!-- 未设置运费模版 -->
          <view v-if="!freight" class="font_value">商家承担</view>
        </li>
      </ul>
      <div class="line"></div>
      ...
      <ul class="info-list">
        <li class="info" @click="toAttribute">
          ...
          <div class="btn-right">
            更多参数
            <img src="http://192.168.1.187:10088/static/images/common/right-gray.png" />
          </div>
        </li>
        <!--        <li class="info border-b">-->
...
<script>
  ...
  export default {
    ...
    onShareAppMessage() {
      console.info(
        'sub-pages/index/item/main?id=' + this.productId + '&sceneType=' + this.sceneType,
      );
      return {
