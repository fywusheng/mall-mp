      ...
      <template v-if="loading || itemList.length">
        <view class="panel" v-for="(el, index) in itemList" :key="index">
          ...
          <view class="panel-body">
            <view class="product-list" :class="{ disabled: item.soldOut }" v-for="product in el.carts" :key="product.id">
              ...
              <view class="product-item-right">
                ...
                <view class="product-price">
                  ...
                  <view class="step">
                    <uni-number-box :value="product.num" min="1" :disabled="!product.soldOut" @onChange="changeCarNum($event, product)" />
                  </view>
                </view>
              </view>
        ...
        <div class="cart-footer">
          ...
          <div class="total">
            <span class="total-price">
              ...
              ¥{{ totalPayablePrice | formatNumber }}
            </span>
