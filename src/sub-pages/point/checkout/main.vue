...
<template>
  <div class="page-checkout" :class="{ isIphoneHair }">
    <div class="checkout-address" @click="selectAddress">
      <img class="icon-address" v-if="settlement.addressId" src="http://192.168.1.187:10088/static/images/checkout/icon-address.png" />
      <img class="icon-you" src="http://192.168.1.187:10088/static/images/checkout/right.png" />
    ...
    <div class="item-list-wrap" v-for="(store, index) in storeList" :key="index">
      ...
      <div class="remark-wrap">
        <span>备注</span>
        <input type="text" maxlength="32" placeholder="选填，请与商家协商并确认" @change="changeRemark($event, index)" />
      </div>
      <div class="remark-wrap">
        <span>积分</span>
        <switch class="right" color="#FF5500" :checked="usePoint" @change="switchChange" style="transform: scale(0.8)" />
        <!-- <span
      ...
      <div class="use-point">
        可用积分共
        <text class="point">994</text>
        分，可抵
        <text class="point">¥8</text>
      </div>
    </div>
    <!-- 无法选购商品 -->
    ...
    <ul class="info-list">
      <li class="info border-b" @click="toCoupon">
        ...
        <img class="icon-you" src="http://192.168.1.187:10088/static/images/checkout/right-gray.png" />
        <coupon-list @setCoupon="setCoupon" :canuseList="canuseList" :notuseList="notuseList" ref="coupon"></coupon-list>
      </li>
    ...
    <div class="checkout-footer">
      <view class="left">
        <div class="total">
          实付:
          <span class="unit">¥</span>
          <span class="total-price">{{ settlement.pendingPaymentAmount | formateNum }}</span>
        </div>
